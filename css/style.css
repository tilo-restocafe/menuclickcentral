...
:root {
    ...
    --bg-card-hover: rgba(31, 41, 67, 0.6);
    --border-glass: rgba(255, 255, 255, 0.07);
    --border-glass-focus: rgba(99, 102, 241, 0.45);
    --text-primary: #f8fafc;
...
.card-hero {
    background: linear-gradient(135deg, rgba(99, 102, 241, 0.18) 0%, rgba(6, 182, 212, 0.05) 100%), var(--bg-card);
    box-shadow: 0 8px 30px rgba(99, 102, 241, 0.1);
}
.card-hero #dash-sucursal-name {
    color: var(--text-primary);
    font-size: 1.35rem;
    font-weight: 700;
}
...
.text-highlight { color: var(--accent-secondary); font-weight: 600; }
...
.status-item .lbl { color: var(--text-secondary); }
...
.header-with-action h4 {
    margin-bottom: 0;
}

.vales-list-container {
    display: flex;
    flex-direction: column;
    gap: 0.75rem;
    min-height: 120px;
...
.vale-item-form select,
.vale-item-form input {
    padding: 0.4rem;
    font-size: 0.8rem;
    border-radius: var(--radius-sm);
    height: 32px;
...
.total-vales-cierre-box label {
    margin-bottom: 0;
    font-weight: 600;
    color: var(--text-primary);
}

.total-vales-cierre-box input {
...
.cierre-row .lbl { color: var(--text-secondary); }
.cierre-row .val { font-weight: 600; }
